...
?>
<footer class="footer"
    style="max-height: 90%; overflow-y: auto; position: fixed; bottom: 0%; left: 50%; transform: translate(-50%); text-align: center; width:99.5%;">
    <div class="text-center"
        style="padding: 0;margin: 0; border-top-left-radius:80px 80px; border-top-right-radius:80px 80px;">

        <div class="panel panel-info"
            style="margin: 0;border-top-left-radius: 50px 60px;border-top-right-radius:50px 60px">
          ...
          <tr>
            ...
            <td><?php echo htmlspecialchars($file->get_downloads_folder(), ENT_QUOTES, 'UTF-8'); ?></td>
                    ...
                    <tr>
                        ...
                        <td>
                            Нажать на <a href="Видео" onclick="$('#vid_link').click()" data-toggle="tab"
                                aria-expanded="false">файл</a> или открыть в новой вкладке
                        </td>
                    </tr>
                    <tr>
                        <td><b>Ошибка?</b></td>
                        <td>
                            ...
                            Файл уже скачан - <a href="Загрузки" onclick="$('#dl_link').click()" data-toggle="tab"
                                aria-expanded="false">проверь историю</a> или <a href="Видео"
                                onclick="$('#vid_link').click()" data-toggle="tab" aria-expanded="false">имя
                                файла</a><br>
                    ...
                    <tr>
                        ...
                        <td>
                            <a target="_blank" rel="noopener noreferrer" href="https://ezgif.com/video-to-gif">Видео в
                                гиф</a> &nbsp;&nbsp;
